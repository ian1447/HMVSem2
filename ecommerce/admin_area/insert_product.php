    ...
    <form action="insert_product.php" method="post" enctype="multipart/form-data">
        <table align="center" width="750" border="2" bgcolor="orange">
            ...
            <tr>
                ...
                <td><input type="text" name="product_title" size="50" required /></ />
                </td>
            </tr>
            <tr>
            ...
            <tr>
                ...
                <td><input type="text" name="product_price" required /></textarea></td>
            </tr>
            <tr>
...
if (isset($_POST['insert_post'])) {
    ...
    echo $insert_product = "insert into product (Product_cat, Product_brand,Product_price, Product_title, Product_desc, Product_image, Product_keywords ) values ($product_cat,$product_brand,$product_price, '$product_title','$product_desc','$product_image','$product_keywords')";
